...
public class Menu extends JFrame implements ActionListener {
    static JFrame f;
    static JTextField textField_1, textField_2, textField_3, textField_4;
    static JButton button1, button2, button3, button4, button5, button6;
    static float number1, number2, number3, result;
    static int operator;
    static Border blackline;
    static Border emptyBorder;
    static Font font = new Font("Britannic Bold", Font.PLAIN, 14);
